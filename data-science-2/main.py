...
ax.set_title('Distribuição de pesos')
plt.show()
...
def q2():
    sample = get_sample(athletes, 'height', 3000)
    jb_value, p_value =  sct.jarque_bera(sample)
    return True if p_value > 0.05 else False
...
def q3():
    ...
    statistic, p_value =  sct.normaltest(sample)
    return True if p_value > 0.05 else False
...
def q4():
    ...
    statistic, p_value =  sct.normaltest(sample_log)
    return True if p_value > 0.05 else False
...
def q5():
    ...
    statistic, p_value = sct.ttest_ind(bra.height, usa.height, equal_var = False, nan_policy = 'omit')
    return True if p_value > 0.05 else False
...
def q6():
    ...
    statistic, p_value = sct.ttest_ind(bra.height, can.height, equal_var = False, nan_policy = 'omit')
    return True if p_value > 0.05 else False
...
def q7():
    ...
    statistic, p_value = sct.ttest_ind(usa.height, can.height, equal_var = False, nan_policy = 'omit')
