...
def get_table_download_link(df):
    ...
    return f'<a href="data:file/csv;base64,{b64}" download="leads.csv"> ![](https://raw.githubusercontent.com/DarleySoares/leads-recommendations/deploy/images/download.png) </a>'